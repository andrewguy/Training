...
You can also get functions from external *packages or libraries* (which we'll talk about in a bit), or [even write your own](http://adv-r.had.co.nz/Functions.html).
...
![CRAN Packages](../img/cran_packages.png)
...
![Bioconductor](../img/bioconductor_logo.png)
...
![ggplot help](../img/ggplot_help.png) 
...
Another way of getting help on particular packages or function is to type a questions mark followed by the package or function name into the console &mdash; this will open up the help page for that function. Note that the package containing this function has to be loaded for this to work.

```r
?ggplot2
```

![ggplot 2 help](../img/ggplot2_help.png)
